        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    {{-- <a href="{{ route('create.suboperator') }}" class="btn btn-success float-right">CREATE</a> --}}
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                  <button class="btn btn-success" id="btn-search" data-url="{{ route('sub.operators') }}" type="button">
