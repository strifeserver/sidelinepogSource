...
{
    public function placePlinkoBet(Request $request){
        ...
        if($wallet->balance < $request['amount']){
           ...
           // return response($request->all());
            ...
            $betData = [
                ...
                'betYellow'=> $betYellow,
                'betWhite'=> $betWhite,
                'myBetRed' => number_format($myBetRed,2,'.',','),
                'myBetBlue' => number_format($myBetBlue,2,'.',','),
                'myBetYellow' => number_format($myBetYellow,2,'.',','),
                'myBetWhite' => number_format($myBetWhite,2,'.',','),
    ...
    public function placePLGhostBet(Request $request){
        $fight = Fight::find($request['fight_id']);
    ...
    public function declareWinnerPlinko(Request $request){
        ...
        $wins = \App\Models\Fight::where('event_id',$event->id)->where('status','finished')->select('result','fight_number','id')->orderBy('id','DESC')->get();
