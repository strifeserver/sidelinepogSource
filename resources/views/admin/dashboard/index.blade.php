                ...
                <div class="card"  role="alert">
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control text-danger bg-white border-0" id="link-input" value="{{ route('register', Auth::user()->referral_code) }}" readonly>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number">₱ {{number_format(($silverAgentCommissions),2,".",",")}}</span>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-md-6">
                <div class="info-box mb-3 bg-primary">
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number">Your Points: {{number_format((Auth::user()->wallet->balance),2,".",",")}}</span>
                    </div>
                </div>
            </div>
            <!-- /.col -->
            <div class="col-12 col-sm-6 col-md-6">
                 <div class="info-box mb-3 bg-success">
                    <div class="info-box-content">
                      <span class="info-box-text">Current Commision <strong class="text-danger">({{Auth::user()->commission}}%)</strong></span>
                      <span class="info-box-number">Your Commission: {{number_format((Auth::user()->wallet->commission),2,".",",")}}</span>
                    </div>
                </div>
            </div>
